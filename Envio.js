...
//  let total = document.querySelector("#total").innerHTML;
	...
	let hola = price.replace('ProductoPrecioCantSub Total',' ');
       ...
       let email = document.querySelector('#email').value
        let message = 'send?phone=' + phone + '&text=*_Formulario Gabriel Chávez_*%0A*Contacto*%0A%0A*¿Cual es tu nombre?*%0A' + name + '%0A*¿Cuáles son tus apellidos?*%0A' + lastname + '%0A*¿Cuál es tu correo?*%0A' + email + '%0A*¿Cuál es tu price?*%0A' + hola2 + ''
